...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        viewHolder.ViewHolder.setText("ViewHolder index: " + String.valueOf(viewHolderCount));
        int color = ColorUtils.getViewHolderBackgroundColorFromInstance(context, viewHolderCount);
        viewHolder.itemView.setBackgroundColor(color);

        ++viewHolderCount;
        Log.i("ViewHolder index = ", String.valueOf(viewHolderCount));
        return viewHolder;
    }
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder {
        ...
        public NumberViewHolder(View itemView) {
            ...
            ViewHolder = (TextView) itemView.findViewById(R.id.tv_view_holder_instance);
        }
